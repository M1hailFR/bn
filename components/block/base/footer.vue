  ...
  <footer
    ...
    <div class="container z-10">
        ...
        <div class="max-w-[350px]">
          <Link href="/">
            <div class="inline-flex items-center gap-2">
              ...
              <h4
                class="mb-0 leading-[.9em] text-4xl"
          ...
          <h5 class="mt-2 py-2">
            ...
            harum, quibusdam dolor facilis excepturi tempora expedita quia in
            maiores voluptates optio esse, rem hic nesciunt fuga aperiam alias
            necessitatibus eum.
          </h5>
        </div>
      ...
      <div class="text-sm font-medium md:w-9/12 mt-20">
        ...
        voluptates optio esse, rem hic nesciunt fuga aperiam alias
        necessitatibus eum.
      </div>
...
.footer {
  @apply relative flex items-center overflow-hidden pt-16 pb-10 text-white;
