		...
		<div class="section-container z-[8] relative">
			<div class="content container flex gap-10 justify-end">
				...
				<div class="flex flex-col text-white">
					<div class="relative left-0 lg:left-[-148px] xl:left-[-128px] h-full  pb-11">
						<h2>{{ data.title }}</h2>
...
<style lang="scss" scoped>
	.request {
		@apply relative flex items-center justify-end overflow-hidden py-10 xl:min-h-[calc(70dvh-200px)];
